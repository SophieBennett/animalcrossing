...
This is an example of the classic Birthday Problem. The trick to calculating it is to start by calculating the **complement**,  - i.e. the probability that _no one_ in the room shares the same birthday, then subtract this probability from 1:

![Equation](../images/bday-problem.png)
